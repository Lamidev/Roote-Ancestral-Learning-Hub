  ...
  try {
    ...
    <head>
      ...
      <style>
        ...
        @media only screen and (max-width:600px){ .container{padding:10px;} .card{padding:20px;} .cta-button{padding:14px 24px; font-size:14px;} }
      </style>
    </head>
    <body>
      <div class="container">
        <div class="card">
          ...
          <div style="text-align:center; margin:30px 0;">
            <a href="${wiseUrl}" class="cta-button">Create Your Account on Wise.live</a>
          </div>
