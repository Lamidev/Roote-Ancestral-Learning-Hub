...
//     try {
//       console.log('💳 Creating Stripe session for:', studentInfo.email);
...
//       console.error("❌ Student info incomplete:", studentInfo);
...
//       console.log("📤 Sending quiz result to:", `${API_BASE_URL}/api/quiz/results`);
//       console.log("📤 Quiz data with courseId:", courseId);
...
//                     size="lg"
//                     className="w-full bg-green-600 hover:bg-green-700 font-outfit shadow-lg hover:shadow-xl transition-all duration-300"
