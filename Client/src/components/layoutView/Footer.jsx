    ...
    <footer className="bg-white text-gray-800 py-12 mt-auto border-t">
      ...
      <div className="container mx-auto px-0 md:px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Brand - Logo aligned far left on mobile */}
          <div className="md:col-span-2">
            <Link 
              to="/" 
              className="flex items-center mb-4 group pl-4 md:pl-0" // ✅ small padding only for mobile
            >
              <img 
                src={rooteLogo} 
                alt="Roote Logo" 
          ...
          <div className="pl-4 md:pl-0">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors duration-300">Student Portal</a></li>
            </ul>
          </div>
        </div>
