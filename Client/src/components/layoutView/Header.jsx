...
//           {/* CTA Button - Only show on home page for desktop */}
...
//               </Button>
//             ) : (
//               // Invisible spacer to maintain layout on other pages
...
import { motion, AnimatePresence } from 'framer-motion';
import { Button } from '@/components/ui/button';
import rooteLogo from '@/assets/rooteLogo.jpg'; // ✅ your logo
...
const Header = () => {
  ...
  return (
    <header className="border-b bg-white/95 backdrop-blur-sm sticky top-0 z-50 shadow-sm">
      {/* ✅ Reduced padding on mobile to push logo left */}
