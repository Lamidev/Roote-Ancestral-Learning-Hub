...
// import { Users, BookOpen, Star, Heart, DollarSign, Shield, Clock } from 'lucide-react';
...
//   return (
//     <div>
//       {/* Hero Section - Reduced top padding to bring content higher */}
//       <section className="bg-linear-to-br from-indigo-50 via-white to-amber-50 py-8 sm:py-12 px-4 overflow-hidden">
//         <motion.div 
